<template>
    <div class="card rounded border-dark col-7 col-sm-6 col-md-5 col-lg-4 ms-4 border-4 p-3">
        <InputMod id="pages" name="pages-number" counter_initial="1"
            @totalPricePanell-emitted="(id, counter) => totalPricePanell(id, counter)" />
        <InputMod id="languages" name="languages-number" counter_initial="1"
            @totalPricePanell-emitted="(id, counter) => totalPricePanell(id, counter)" />
    </div>
</template>
